...
<head>
    ...
    <title>arta confirm_password</title>
</head>
<body>
<div class="row">
    <div class="col-6 row ">
    ...
    <div class="col-6 container px-3 rounded-5 w-25 shadow-lg" style="background-color: #E7E7E7;margin: 252px ">
        ...
        <form class="my-1 mx-3 p-2">
            ...
            <div class="text-end my-3 "> <h2>!!تعيين كلمة المرور</h2></div>
            <div class="text-end my-3 text-black-50 "> <span>!!يرجاء تعيين كلمة المرور جديدة لحسابك</span></div>
...
{{--                    </button>--}}
            ...
            <div class="text-center"><input class="btn  w-100 py-3 rounded-4 text-white" style="background-color: #185878" type="submit" value="تعيين كلمة المرور"></div>
            <hr>
            <!--        <div class="login-or">-->
